...
module.exports = {
    paste: function() {
        ...
        // var porjectDir = atom.packages.getActivePackage('tree-view').mainModule.provideTreeView().selectedPaths()[0];
        var projectDir = atom.project.getDirectories()[0].getPath();
        ...
        if (img.isEmpty()) {
            ...
            console.log("clipboard path:" + path);
        ...
        if (!img.isEmpty()) {
            ...
            imgbuffer = fs.readFileSync(path, null);
        }

        console.log("paste image buffer size:" + imgbuffer.length);
